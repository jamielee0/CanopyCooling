...
The current main pilot contains **11 Phoenix and 5 Atlanta observations, all from 2023**. This repository publishes the precision/method review snapshot, including:

- [Completed work, limitations and decisions for discussion](review/v6.2-2023-pilot/01_Progress_and_decisions.md)
...
This is a review snapshot, not approval for full-city scaling or a final time-pattern/scale-agreement conclusion.
