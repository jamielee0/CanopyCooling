...
- Original ten-pass checks plus completed six-addition registration/fixed-support comparisons and common-cell refits across all eleven Phoenix passes (23 September); native ownership audit; initial mixing scenarios and standardized inversion on the original ten passes.
...
4. Review the completed added-pass registration and common-cell comparisons under the coefficient-release rules. Their precision/support results are available; effect differences remain sealed. Retain spatial residual/range checks and 1/2/4/8 km sensitivity; 8 km is not a demonstrated independence distance. Changing clouds changes the contributing geography.
...
23 September: [65 completed paired robustness fits and their limitations](checks/phoenix_robustness_20260923/README.md). No new observations, empirical time fit or scale-agreement ruling.
